...
class Application:
    ...
    def pairs(self, tab):
        ...
        # Words Textarea
        self.text_areaPairs = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30)
        self.text_areaPairs.grid(column=1, padx=10, pady=10, row=2, rowspan=2)
        self.text_areaPairs.focus()

        # Pairs Textarea result
        self.text_area_resultPairs = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30,
                                                               state='disabled')
        self.text_area_resultPairs.grid(column=3, padx=25, row=2, rowspan=2)

        # Submit Button
        self.submitPairs = Button(tab, text='Crear Parejas', command=self.executePairs)
        self.submitPairs.grid(column=2, row=2, pady=10)

        # Copy Button Pairs
        self.copyPairs = Button(tab, text='Copiar Resultado', command=self.copyPairs)
    ...
    def twins(self, tab):
        ...
        self.text_areaTwins = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30)
        self.text_areaTwins.grid(column=1, padx=10, pady=10, row=2, rowspan=2)
        self.text_areaTwins.focus()

        # Pairs Textarea result
        self.text_area_resultTwins = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30,
                                                               state='disabled')
        self.text_area_resultTwins.grid(column=3, padx=25, row=2, rowspan=2)

        # Submit Button
        self.submitTwins = Button(tab, text='Crear gemelos', command=self.executeTwins)
        self.submitTwins.grid(column=2, row=2, pady=10)

        # Copy Button Twins
        self.copyTwins = Button(tab, text='Copiar Resultado', command=self.copyTwins)
        self.copyTwins.grid(column=2, row=3, pady=10)

    def uniqueTwins(self, tab):
        # Title Label
        ttk.Label(tab,
        ...
        self.text_areaUniqueTwins = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30)
        ...
        self.text_area_resultUniqueTwins = scrolledtext.ScrolledText(tab, wrap=tk.WORD, width=40, height=30,
                                                                     state='disabled')
        self.text_area_resultUniqueTwins.grid(column=3, padx=25, row=2, rowspan=2)

        # Submit Unique Twins Button
        self.submitUniqueTwins = Button(tab, text='Crear gemelos únicos', command=self.executeUniqueTwins)
        self.submitUniqueTwins.grid(column=2, row=2, pady=10)

        # Copy Button Twins
        self.copyUniqueTwins = Button(tab, text='Copiar Resultado', command=self.copyUniqueTwins)
